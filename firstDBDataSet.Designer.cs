...
namespace QuanLySinhVien {
    ...
    public partial class firstDBDataSet : global::System.Data.DataSet {
        ...
        public partial class StudentDataTable : global::System.Data.TypedTableBase<StudentRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public StudentRow AddStudentRow(string StudentID, string Name, string Address, System.DateTime DateOfBirth) {
...
namespace QuanLySinhVien.firstDBDataSetTableAdapters {
    ...
    public partial class StudentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Student] WHERE (([StudentID] = @Original_StudentID) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] = @Original_Address)) AND ((@IsNull_DateOfBirth = 1 AND [DateOfBirth] IS NULL) OR ([DateOfBirth] = @Original_DateOfBirth)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Student] ([StudentID], [Name], [Address], [DateOfBirth]) VALUE" +
                "S (@StudentID, @Name, @Address, @DateOfBirth);\r\nSELECT StudentID, Name, Address," +
                " DateOfBirth FROM Student WHERE (StudentID = @StudentID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Student] SET [StudentID] = @StudentID, [Name] = @Name, [Address] = @Address, [DateOfBirth] = @DateOfBirth WHERE (([StudentID] = @Original_StudentID) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] = @Original_Address)) AND ((@IsNull_DateOfBirth = 1 AND [DateOfBirth] IS NULL) OR ([DateOfBirth] = @Original_DateOfBirth)));
SELECT StudentID, Name, Address, DateOfBirth FROM Student WHERE (StudentID = @StudentID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT StudentID, Name, Address, DateOfBirth FROM dbo.Student";
        ...
        public virtual int Delete(string Original_StudentID, string Original_Name, string Original_Address, global::System.Nullable<global::System.DateTime> Original_DateOfBirth) {
        ...
        public virtual int Insert(string StudentID, string Name, string Address, global::System.Nullable<global::System.DateTime> DateOfBirth) {
            if ((StudentID == null)) {
        ...
        public virtual int Update(string StudentID, string Name, string Address, global::System.Nullable<global::System.DateTime> DateOfBirth, string Original_StudentID, string Original_Name, string Original_Address, global::System.Nullable<global::System.DateTime> Original_DateOfBirth) {
            if ((StudentID == null)) {
                throw new global::System.ArgumentNullException("StudentID");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Address, global::System.Nullable<global::System.DateTime> DateOfBirth, string Original_StudentID, string Original_Name, string Original_Address, global::System.Nullable<global::System.DateTime> Original_DateOfBirth) {
            return this.Update(Original_StudentID, Name, Address, DateOfBirth, Original_StudentID, Original_Name, Original_Address, Original_DateOfBirth);
        }
    }
